...
export const FounderSection: React.FC = () => {
  ...
  return (
    <section id="about" className="py-24 sm:py-32 bg-[#faf8f5] text-stone-800 border-b border-[#e8dfd5] relative overflow-hidden">
      {/* Background Architectural Grid Pattern */}
      <div className="absolute inset-0 opacity-10 pointer-events-none bg-[radial-gradient(#c5a059_1px,transparent_1px)] [background-size:24px_24px]"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mb-16">
          ...
          <h2 className="font-display text-4xl sm:text-6xl font-light text-[#1e1b18] tracking-tight leading-tight">
            Craftsmanship Rooted in <br />
            <span className="italic font-normal text-[#8c6f50]">Architectural Discipline.</span>
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            {/* Founder Identity */}
            <div className="space-y-2 border-b border-[#e8dfd5] pb-6">
              <h3 className="font-display text-3xl sm:text-4xl font-normal text-[#1e1b18] tracking-wide">
            ...
            {businessProfile.ownerVision && (
              <div className="py-6 pl-6 border-l-2 border-[#c5a059] text-stone-700 bg-transparent">
                ...
                <p className="font-display text-lg sm:text-xl font-light text-stone-800 leading-relaxed italic">
                  "{businessProfile.ownerVision}"
                </p>
              </div>
            )}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
              <div className="p-4 bg-white border border-[#e8dfd5] shadow-sm">
                <div className="text-xs font-semibold uppercase tracking-wider text-[#c5a059] mb-1">
                  1. Zero Site Mess
                </div>
                <div className="text-xs text-stone-500 font-light leading-snug">
            ...
            <div className="pt-4 flex flex-wrap items-center gap-4">
              <button
                ...
                className="px-6 py-3.5 bg-[#1e1b18] hover:bg-[#c5a059] text-white hover:text-[#1e1b18] text-xs font-bold uppercase tracking-[0.18em] transition-all duration-300 cursor-pointer flex items-center gap-2 shadow-lg"
              >
              ...
              <a
                ...
                className="px-6 py-3.5 bg-transparent hover:bg-stone-100 text-stone-700 border border-stone-300 text-xs font-semibold uppercase tracking-[0.18em] transition-colors flex items-center gap-2"
              >
