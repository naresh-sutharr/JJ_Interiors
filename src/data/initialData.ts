...
export const initialServices: Service[] = [
  {
    ...
    iconName: "Home",
    shortDesc: "End-to-end turnkey interior design solutions for modern residences in Surat.",
    fullDesc: "Comprehensive turnkey interior design services for your entire home. From spatial layouts to material selection, we provide complete execution for beautiful and functional living spaces in Surat and Gujarat.",
    features: ["Space Planning", "Material Curation", "End-to-End Execution", "Turnkey Interiors"],
  ...
  },
  {
    ...
    iconName: "CookingPot",
    shortDesc: "Ergonomic, waterproof custom modular kitchens with premium hardware.",
    fullDesc: "Engineered for your culinary needs. Our bespoke modular kitchens in Surat use water-resistant core boards, premium fittings, tandem box drawers, and smart pull-outs for maximum efficiency.",
    features: ["Waterproof Boards", "Soft-Close Hardware", "Smart Storage Layouts", "Custom Layouts"],
  ...
  },
  {
    ...
    iconName: "Shirt",
    shortDesc: "Custom sliding and open wardrobes designed by top wardrobe designers.",
    fullDesc: "Maximize your vertical storage with our precision-cut modular wardrobes. As a leading wardrobe designer in Surat, we offer sliding shutters, fluted glass, integrated lighting, and smart organizers.",
    features: ["Floor-to-Ceiling Storage", "Custom Organizers", "Integrated Lighting"],
    image: "https://images.unsplash.com/photo-1595526114101-224dc6c95d71?auto=format&fit=crop&w=900&q=80",
    active: true,
    order: 3,
  },
  {
    ...
    iconName: "Armchair",
    shortDesc: "Inviting living spaces with bespoke custom furniture and elegant wall treatments.",
    fullDesc: "We create welcoming, conversational living areas with custom TV units, false ceilings, mood lighting, and comfortable bespoke seating arrangements tailored for your home.",
  ...
  },
  {
    ...
    iconName: "BedDouble",
    shortDesc: "Restful, personalized bedroom designs with luxurious custom finishes.",
    fullDesc: "Design your personal sanctuary. Our bedroom interior designs feature upholstered headboards, optimal space utilization, ambient lighting, and perfectly crafted side tables.",
    features: ["Upholstered Headboards", "Space Optimization", "Ambient Lighting"],
  ...
  },
  {
    ...
    iconName: "Briefcase",
    shortDesc: "Productive and brand-aligned office interior design in Surat.",
    fullDesc: "As an expert office interior designer in Surat, we build ergonomic, inspiring workspaces. From corporate offices to retail showrooms, we ensure your commercial space reflects your brand identity.",
    features: ["Ergonomic Layouts", "Brand Integration", "Commercial Grade Finishes"],
