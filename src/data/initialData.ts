...
export const initialServices: Service[] = [
  {
    ...
    iconName: "Home",
    shortDesc: "Complete interior solutions for modern homes, bringing your vision to life.",
    fullDesc: "Comprehensive interior design services for your entire home. From spatial layouts to material selection, we provide end-to-end turnkey solutions for a beautiful and functional living space.",
  ...
  {
    id: "srv-7",
    title: "Dining & Home Furniture",
    slug: "dining-and-home-furniture",
    iconName: "Utensils",
    shortDesc: "Beautiful dining areas and assorted modular home furniture.",
    fullDesc: "Custom dining tables, crockery units, and complete home furniture sets manufactured with precision and quality materials.",
    features: ["Crockery Units", "Custom Tables", "Precision Manufacturing"],
  ...
  },
  {
    ...
    iconName: "Building",
    shortDesc: "Practical and professional commercial spaces and clinics.",
    fullDesc: "Complete commercial interior solutions focusing on durability, traffic flow, and professional aesthetics on strict deadlines.",
    features: ["Durable Finishes", "Professional Look", "Timely Execution"],
  ...
  },
  {
    ...
    iconName: "Briefcase",
    shortDesc: "Productive workspaces, executive cabins, and workstations.",
    fullDesc: "Ergonomic workstations, conference rooms, executive suites, and welcoming reception areas tailored for modern businesses.",
    features: ["Ergonomic Workstations", "Reception Areas", "Cable Management"],
    image: "https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=900&q=80",
    active: true,
    order: 10,
  },
  {
    ...
    iconName: "Store",
    shortDesc: "Turnkey retail showrooms and boutique displays.",
    fullDesc: "Enhance customer experience and highlight merchandise with bespoke display units, strategic lighting, and beautiful retail environments.",
    features: ["Display Units", "Retail Lighting", "Customer Flow"],
