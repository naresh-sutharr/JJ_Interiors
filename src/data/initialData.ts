...
export const initialBusinessProfile: BusinessProfile = {
  ...
  ownerName: "Gopalram P. Suthar",
  ownerDesignation: "Founder & Creative Director",
  ownerExperienceYears: 10,
  ownerPhoto: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=800&q=80",
  ownerBio: "With over a decade of dedicated craftsmanship and architectural precision, Gopalram P. Suthar founded J.J. INTERIORS & MODUTECH to synthesize bespoke residential and commercial design with factory-grade modular manufacturing. Every space is curated with disciplined proportions, honest materials, and enduring functional quality.",
  ...
  phone: "+91 94270 54921",
  whatsapp: "+91 94270 54921",
  email: "info@jjinteriors.site",
  address: "148, RandalDham Society, ChanakyaPuri, New Sama Road, Vadodara - 390008, Gujarat, India",
  city: "Vadodara",
  state: "Gujarat",
  pin: "390008",
  panNo: "CMPYS4786H",
  gstin: "24CMPYS4786H1Z5",
...
export const initialServices: Service[] = [
  {
    ...
    iconName: "Compass",
    shortDesc: "End-to-end bespoke residential & commercial interior architecture with curated spatial flow and material harmony.",
    fullDesc: "Comprehensive interior design services from initial 3D visualization and spatial layouts to material selection, lighting design, and turnkey on-site execution for discerning clients.",
    features: ["Custom Spatial Planning", "3D Photorealistic Renders", "Moodboards & Material Curation", "Turnkey Site Execution"],
  ...
  },
  {
    ...
    iconName: "Armchair",
    shortDesc: "Factory-crafted precision furniture with zero-joint edge banding, seamless joinery, and durable core boards.",
    fullDesc: "Manufactured at our dedicated Modutech facility with 0.8mm to 2mm zero-joint edge banding, European machinery, and high-density fiberboards for zero site wood dust and millimeter accuracy.",
    features: ["Zero-Joint Edge Banding", "Termite & Borer Proof Core", "Factory-Grade Precision Finishes", "Fast-Track On-site Assembly"],
  ...
  },
  {
    ...
    iconName: "CookingPot",
    shortDesc: "Ergonomic, 100% waterproof modular kitchens with German soft-close tandem systems and anti-scratch quartz tops.",
    fullDesc: "Engineered for intensive culinary routines with HDHMR water-resistant core boards, quartz stone surfaces, Blum/Hettich fittings, tandem box drawers, and smart corner carousel pantries.",
    features: ["Waterproof HDHMR Boards", "Blum Soft-Close Mechanics", "Seamless Quartz & Ceramic Countertops", "Smart Corner Pull-outs & Pantries"],
  ...
  },
  {
    ...
    slug: "wardrobes",
    iconName: "Shirt",
    shortDesc: "Floor-to-ceiling sliding wardrobes, walk-in closets, tinted fluted glass, and automated motion LED lighting.",
    fullDesc: "Maximize vertical storage with precision-cut modular wardrobes featuring tinted fluted glass, integrated warm sensor LEDs, and anti-warp aluminum profiles with soft-close dampers.",
    features: ["Floor-to-Ceiling Profile Shutters", "Integrated Soft Motion Sensors", "Velvet Accessory Organizers", "Moisture-Sealed Wardrobe Carcass"],
  ...
  },
  {
    ...
    slug: "living-spaces",
    iconName: "Home",
    shortDesc: "Architectural living rooms, bespoke TV entertainment consoles, acoustic wall paneling, and curated seating.",
    fullDesc: "Creating welcoming, conversational living areas with floating media walls, concealed cable runs, architectural false ceilings, indirect mood lighting, and bespoke upholstered furnishings.",
    features: ["Acoustic Timber Louver Walls", "Concealed Cable Management", "Custom Coffee & Accent Consoles", "Layered Architectural Lighting"],
  ...
  },
  {
    ...
    slug: "bedrooms",
    iconName: "Bed",
    shortDesc: "Serene master sanctuaries, hydraulic platform beds, custom headboards, and integrated study desks.",
    fullDesc: "Personal sanctuaries designed for deep rest and refined privacy. Platform beds with gas-lift storage, acoustic headboard panels, seamless vanity consoles, and soothing ambient lighting.",
    features: ["Hydraulic Platform Storage Beds", "Bespoke Upholstered Headboards", "Integrated Vanity & Bedside Units", "Quiet Neutral Color Palettes"],
  ...
  },
  {
    ...
    iconName: "Briefcase",
    shortDesc: "High-productivity executive cabins, conference pods, modular loop workstations, and reception lounges.",
    fullDesc: "Ergonomic workstations, glass conference pods, executive suites, and welcoming reception areas tailored for corporate agility and modern hybrid work patterns.",
    features: ["Acoustic Pods & Partitions", "Cable-Managed Workstations", "Brand-Centric Reception Lounges", "Heavy-Duty Powder-Coated Frames"],
  ...
  },
  {
    ...
    iconName: "Building2",
    shortDesc: "Turnkey retail showrooms, boutique clinics, luxury display studios, and experiential commercial environments.",
    fullDesc: "End-to-end commercial solutions that optimize customer traffic flow, highlight merchandise with high-CRI lighting, and deliver durable, fire-rated finishes on strict deadlines.",
    features: ["Customer Circulation Planning", "High-CRI Retail Display Lighting", "Durable Commercial Grade Finishes", "Fast-Track Handover Schedules"],
  ...
  {
    id: "srv-9",
    title: "Modutech Solutions",
    slug: "modutech-solutions",
    iconName: "Sparkles",
    shortDesc: "Proprietary factory-engineering system with European CNC precision, zero site mess, and 10-year durability.",
    fullDesc: "Our proprietary manufacturing standard: all cutting, boring, grooving, and edge sealing happens in our controlled factory facility. Enjoy 100% dust-free on-site assembly, precise joints, and zero material wastage.",
    features: ["European CNC Precision Cutting", "Zero On-Site Wood Sawing Dust", "10-Year Structural Board Warranty", "Tested Hardware Load Resilience"],
...
8. This is a computer generated invoice and does not require a physical signature.`,
  ...
  bankDetails: {
    ...
    accountName: "J.J. INTERIORS & MODUTECH",
    accountNumber: "1234 5678 9012",
    ifscCode: "HDFC0001234",
    branch: "Vadodara / Surat, Gujarat",
    upiId: "jjinteriors@okhdfcbank",
  }
};
